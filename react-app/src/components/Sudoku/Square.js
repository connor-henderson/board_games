...
export default function Square({ i, j, num, solution, board }) {
  ...
  function handleClick(e) {
    ...
    const boxSquares = getBoxSquares(rowNum-rowNum%3, colNum-colNum%3);
  ...
  return (
    <td
      ...
      className={num ? `row-${i} col-${j} preset` : `row-${i} col-${j} unset`}
