  ...
  return (
    <>
      <div className="about-container">
        ...
        <p>
          This website is for enjoying of the logic of computers, board games,
          and writing board games for computers
        </p>
      </div>
      <div className="about-links">
        <a href="https://github.com/cch41">
          <img style={{ heigth: "30px", width: "30px" }} src={github} />
        </a>
        <a href="https://www.linkedin.com/in/connor-henderson-833504123/">
          <img style={{ heigth: "30px", width: "30px" }} src={linkedIn} />
        </a>
      </div>
    </>
  );
